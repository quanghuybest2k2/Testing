                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">
                                Chúng tôi vừa có một sản phẩm mới, hi
                                vọng bạn sẽ không bỏ
                                lỡ những khoảnh khắc đáng yêu của các thú cưng.</p>
                        </td>
                    </tr>
                    <!-- ten san pham -->
                    <tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0; color: #FFA73B;">{{ $product->name }}</p>
                        </td>
                    </tr>
                    <!-- end ten san pham -->
                    <!-- mo ta san pham -->
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0; color: #FFA73B;">{{ $product->description }}</p>
                        </td>
                    </tr>
                    <!-- end mo ta san pham -->
                    <!-- gia ban san pham -->
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0; color: #FFA73B;">
                                {{ number_format($product->selling_price, 0, ',', '.') }} VNĐ</p>
                        </td>
                    </tr>
                    <!-- end gia ban san pham -->
                    <!-- thuong hieu san pham -->
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            style="padding: 0px 30px 0px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;">Thương hiệu:</p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0; color: #FFA73B;">{{ $product->brand }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Nếu bạn có bất kỳ câu hỏi nào, chỉ cần trả lời email này—chúng tôi
                                luôn sẵn lòng trợ giúp.</p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;">Thân ái!<br>PetShop Team</p>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFECD1" align="center"
                            ...
                            <h2 style="font-size: 20px; font-weight: 400; color: #111111; margin: 0;">Cần thểm sự hỗ
                                trợ?
                            </h2>
                            <p style="margin: 0;"><a href="#" target="_blank" style="color: #FFA73B;">Chúng
                                    tôi ở đây để giúp bạn</a></p>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#f4f4f4" align="left"
                            ...
                            <br>
                            <p style="margin: 0;">Nếu những email này gây khó chịu, vui lòng <a href="#"
                                    target="_blank" style="color: #111111; font-weight: 700;">hủy đăng ký</a>.</p>
                        </td>
                    </tr>
                </table>
            </td>
